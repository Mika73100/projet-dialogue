...
const HelpScreen = () => {
    ...
    return (
        <View className="px-4 pt-4 p-2">
            ...
            <View className="flex justify-center items-center w-full p-2 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <Text className="px-4 pt-4 p-2">Question :</Text>
                <View class="rightBottom h-25">
                    <View class="questionTextarea position-relative flex d-flex rounded-3  w-75  bottom-0  align-content-center justify-content-between mx-auto ">
                        <Text className="px-4 pt-4 p-2">IA</Text>
                    </View>
                </View>
            </View>
        </View>
