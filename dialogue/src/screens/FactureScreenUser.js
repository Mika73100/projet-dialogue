            ...
            renderItem={({ item }) => (
              ...
              >
                <View className="flex-1 items-center justify-center mt-5 tracking-widest text-center text-white bg-blue-500 rounded-lg mx-5">
                  <Text className="mt-5 text-white"> Facture du : {formatDateTimeFrench(item.date)}</Text>
                  <Text className="flex-1 mt-5 tracking-widest text-center rounded-lg mx-5 mb-4 text-white"> Télécharger PDF</Text>
                </View>
              </TouchableOpacity>
            )}
          />
